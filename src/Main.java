...
/////////////loading starting values/////////////////////////////////////////
	public static boolean loadCustomers(DeliveryDataBase system) {
		...
		success = system.addCustomer(new Customer("1001", "Ahmad", "Ali", new Address("10 Herzl", "Haifa", "12345"),
				"0521234567", "ahmad@gmail.com", 100)) && success;
		success = system.addCustomer(new Customer("1002", "Noa", "Cohen", new Address("20 Hanamal", "Haifa", "23456"),
				"0531234567", "noa@gmail.com", 250)) && success;
		success = system.addCustomer(new Customer("1003", "David", "Levi",
				new Address("30 Allenby", "Tel Aviv", "34567"), "0541234567", "david@gmail.com", 0)) && success;
		success = system.addCustomer(new Customer("1004", "Sara", "Mansour",
				new Address("40 Hagalil", "Nazareth", "45678"), "0551234567", "sara@gmail.com", 55)) && success;
		success = system.addCustomer(new Customer("1005", "Lina", "Haddad", new Address("50 Carmel", "Haifa", "56789"),
				"0561234567", "lina@gmail.com", 70)) && success;
		success = system.addCustomer(new Customer("1006", "Omar", "Nassar",
				new Address("60 Begin", "Jerusalem", "67890"), "0571234567", "omar@gmail.com", 900)) && success;
		success = system.addCustomer(new Customer("1007", "Maya", "Bar", new Address("70 Yaffo", "Acre", "78901"),
				"0581234567", "maya@gmail.com", 60)) && success;
		success = system.addCustomer(new Customer("1008", "Rami", "Saleh", new Address("80 Shalom", "Haifa", "89012"),
				"0591234567", "rami@gmail.com", 33)) && success;
		success = system.addCustomer(new Customer("1009", "Dana", "Mor", new Address("90 Nof", "Tiberias", "90123"),
				"0501234567", "dana@gmail.com", 300)) && success;
		success = system.addCustomer(new Customer("1010", "Yara", "Khalil", new Address("100 Hadar", "Haifa", "11223"),
	...
	public static boolean loadRestaurants(DeliveryDataBase system) {
		...
		boolean success = true;
		// Regular restaurants
		success = system.addRestaurant(new Restaurant("2001", "Burger House", "Fast Food", 4.5, true, 15)) && success;
		success = system.addRestaurant(new Restaurant("2002", "Pizza Corner", "Italian", 4.1, true, 10)) && success;
		success = system.addRestaurant(new Restaurant("2003", "Green Bowl", "Healthy", 4.3, true, 12)) && success;
		success = system.addRestaurant(new Restaurant("2004", "Mama Pasta", "Italian", 4.0, false, 14)) && success;
		success = system.addRestaurant(new Restaurant("2005", "Falafel King", "Middle Eastern", 4.6, true, 8))
				&& success;
		success = system.addRestaurant(new Restaurant("2006", "Wok Time", "Chinese", 4.2, true, 11)) && success;
		success = system.addRestaurant(new Restaurant("2007", "Taco Place", "Mexican", 4.4, true, 13)) && success;
		success = system.addRestaurant(new Restaurant("2008", "Sea Food Bay", "Seafood", 4.7, true, 20)) && success;
		success = system.addRestaurant(new Restaurant("2009", "Village Kitchen", "Homemade", 4.1, true, 9)) && success;
		success = system.addRestaurant(new Restaurant("2010", "Coffee Spot", "Cafe", 4.0, true, 7)) && success;
		// Fast food restaurants
		success = system.addRestaurant(new FastFoodRestaurant("2011", "Quick Bite", "Fast Food", 4.2, true, 12, 20, 8))
				&& success;
		success = system.addRestaurant(new FastFoodRestaurant("2012", "Speedy Sushi", "Japanese", 4.4, true, 18, 15, 6))
				&& success;
		success = system.addRestaurant(new FastFoodRestaurant("2013", "Rapid Pizza", "Italian", 4.1, true, 10, 12, 5))
				&& success;
		success = system.addRestaurant(
				new FastFoodRestaurant("2014", "Burger Express", "Fast Food", 4.5, true, 14, 10, 4)) && success;
		success = system.addRestaurant(new FastFoodRestaurant("2015", "Hot Dog Hub", "American", 4.0, true, 9, 8, 3))
				&& success;
		success = system.addRestaurant(
		...
		success = system.addRestaurant(new FastFoodRestaurant("2018", "Snack Attack", "Snacks", 3.9, true, 7, 6, 2))
				&& success;
		success = system.addRestaurant(new FastFoodRestaurant("2019", "Fast Noodles", "Asian", 4.2, true, 10, 11, 4))
				&& success;
		success = system.addRestaurant(new FastFoodRestaurant("2020", "Toast Point", "Cafe", 4.0, true, 8, 7, 3))
				&& success;
		// Premium restaurants
		success = system.addRestaurant(
				new PremiumRestaurant("2021", "Royal Steak", "Steakhouse", 4.9, true, 25, 100, 10)) && success;
		success = system.addRestaurant(new PremiumRestaurant("2022", "Luxury Grill", "Grill", 5.0, true, 30, 150, 12))
				&& success;
		success = system.addRestaurant(new PremiumRestaurant("2023", "Golden Fish", "Seafood", 4.8, true, 28, 120, 11))
				&& success;
		success = system.addRestaurant(new PremiumRestaurant("2024", "Elite Sushi", "Japanese", 4.9, true, 26, 130, 10))
				&& success;
		success = system.addRestaurant(new PremiumRestaurant("2025", "Diamond Pasta", "Italian", 4.7, true, 24, 110, 9))
				&& success;
		success = system.addRestaurant(new PremiumRestaurant("2026", "Sky Lounge", "Fusion", 4.8, true, 35, 200, 15))
				&& success;
		success = system.addRestaurant(new PremiumRestaurant("2027", "Chef Palace", "French", 4.9, true, 32, 180, 14))
				&& success;
		success = system.addRestaurant(
				new PremiumRestaurant("2028", "Prestige Dining", "International", 4.6, true, 27, 140, 10)) && success;
		success = system.addRestaurant(
				new PremiumRestaurant("2029", "Prime Taste", "Steakhouse", 4.7, true, 29, 160, 13)) && success;
		success = system.addRestaurant(new PremiumRestaurant("2030", "Ocean Pearl", "Seafood", 4.8, true, 31, 170, 12))
				&& success;
		return success;
	}
	...
	public static boolean loadRiders(DeliveryDataBase system) {
		...
		boolean success = true;
		success = system.addRider(new Rider("123456789", "Ahmad", "Ali", "0521234567", "car", true)) && success;
		success = system.addRider(new Rider("987654321", "Noa", "Cohen", "0532345678", "bike", true)) && success;
		success = system.addRider(new Rider("456789123", "David", "Levi", "0543456789", "motorBike", true)) && success;
		success = system.addRider(new Rider("741852963", "Lina", "Haddad", "0554567890", "car", false)) && success;
		success = system.addRider(new Rider("159357486", "Omar", "Nassar", "0565678901", "bike", true)) && success;
	...
	public static boolean loadRestAdmins(DeliveryDataBase system) {
		...
		boolean success = true;
		success = system.addRestAdmin(new RestAdmin("Ahmad Ali", "ahmadAdmin", "1234")) && success;
		success = system.addRestAdmin(new RestAdmin("Noa Cohen", "noaAdmin", "5678")) && success;
		success = system.addRestAdmin(new RestAdmin("David Levi", "davidAdmin", "9999")) && success;
...
///////////////// menu helper methods ///////////////////////////////////////////
	public static void systemAdminMenu(Scanner input, DeliveryDataBase system) {
		...
		while (adminChoice != 0) {
			...
			case 8:
				System.out.println(system.getCustomerWithMostOrders());
				break;

			case 9:
				System.out.println(system.getRiderWithMostDeliveries());
				break;
	...
	public static void restaurantAdminMenu(Scanner input, DeliveryDataBase system) {
		...
		while (adminChoice != 0) {
			...
			case 4:
				...
				break;
			case 5:
				printOrdersByRestaurantFromInput(input, system, loggedAdmin);
				break;
			case 6:
	...
	public static void customerMenu(Scanner input, DeliveryDataBase system) {
		...
		while (customerChoice != 0) {
			...
			case 4:
				...
				break;
			case 5:
				printRestaurantsOrderedByCustomer(system, loggedCustomer);
				break;
			case 6:
				printPremiumRestaurantsByCustomer(system, loggedCustomer);
				break;
			case 7:
...
//////////// helper methods//////////////////////////
	public static void addCustomerFromInput(Scanner input, DeliveryDataBase system) {
		...
		Customer customer = new Customer(code, firstName, familyName, address, phoneNum, mail, refund);
	...
	public static void addRestaurantFromInput(Scanner input, DeliveryDataBase system) {
		...
		System.out.println(
				"Please choose what kind of restaurant you would like to add:\n1: Regular restaurant\n2: Fast food restaurant\n3: Premium restaurant");
		int choice = -1;
		...
		if (choice == 1) {
			...
			restaurant = new FastFoodRestaurant(code, name, cuisine, rating, isOpen, baseDeliveryFee, averagePrepTime,
					fastDeliveryFee);
		} else if (choice == 3) {
			...
			restaurant = new PremiumRestaurant(code, name, cuisine, rating, isOpen, baseDeliveryFee, minOrderAmount,
	...
	public static void addRiderFromInput(Scanner input, DeliveryDataBase system) {
		...
		while (true) {
			...
			if (!InputValidation.isOnlyDigits(phoneNum) || phoneNum.length() != 10 || !phoneNum.startsWith("05")) {
		...
		Rider rider = new Rider(id, firstName, familyName, phoneNum, vehicle, true);
	...
	public static void addOrderFromInput(Scanner input, DeliveryDataBase system, RestAdmin loggedAdmin) {
		...
		while (true) {
			...
			if (orderDate.getDay() == day && orderDate.getMonth() == month && orderDate.getYear() == year) {
				break;
			}
	...
	public static void assignRiderToOrderFromInput(Scanner input, DeliveryDataBase system, RestAdmin loggedAdmin) {
		...
		while (system.findRiderById(riderId) == null || !system.findRiderById(riderId).isAvailable()) {
	...
	public static void updateOrderStatusToDelivered(Scanner input, DeliveryDataBase system, Rider loggedRider) {
		// this method updates order status to "delivered" and validates the delivery
		// date
		String orderCode;
		Order order;
		int day, month, year;
		...
		while (true) {
			...
			if (deliveryDate.getDay() == day && deliveryDate.getMonth() == month && deliveryDate.getYear() == year) {
				break;
			}
			System.out.println("Invalid date, try again");
		}
	...
	public static void updateCustomerAddress(Scanner input, DeliveryDataBase system, Customer loggedCustomer) {
		// this method is a helper for "updateCustomerInfoFromInput" to update the
		// address
	...
	public static void updateRestaurantStatusFromInput(Scanner input, DeliveryDataBase system) {
		...
		while (true) {
			System.out.println("restaurant code:");
			String restaurantCode = input.next();
			restaurant = system.findRestaurantByCode(restaurantCode);
			if (restaurant == null) {
		...
		boolean isOpen;
		while (true) {
			System.out.println("Enter true to open, false to close");
			if (input.hasNextBoolean()) {
				isOpen = input.nextBoolean();
				break;
			} else {
	...
	public static void printOrdersByRestaurantFromInput(Scanner input, DeliveryDataBase system, RestAdmin loggedAdmin) {
		...
		while (true) {
			...
			restaurantCode = input.next();
			if (!InputValidation.isNotEmpty(restaurantCode) || !InputValidation.isOnlyDigits(restaurantCode)) {
				System.out.println("Invalid restaurant code.");
			} else {
				restaurant = system.findRestaurantByCode(restaurantCode);
				if (restaurant == null) {
		...
		boolean found = false;
		for (Order order : system.getOrders()) {
			if (order.getRestaurantCode().equals(restaurantCode)) {
	...
	public static void printOpenRestaurantsByCuisineFromInput(Scanner input, DeliveryDataBase system) {
		...
		ArrayList<Restaurant> restaurants = system.getOpenRestaurantsByCuisine(cuisine);
