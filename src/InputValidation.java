...
public class InputValidation {
	// this method checks if string is only digits and return true if it is and
	// false otherwise
	...
	// this method checks if string is empty and returns true if it isnt and false
	// otherwise
	...
	// this method checks if string has only letters and return true if it is anf
	// false otherwise
	...
	// this method checks if the email is valid : contains only one "@" and its not
	// at the start, a "." after it,
